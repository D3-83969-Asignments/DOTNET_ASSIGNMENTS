namespace Question11
{
    ...
    public class Supervisor : Employee
    {
        ...
        {
            base.Accept();
            Console.WriteLine("Enter the number of Assistants");
    ...
    public class WageEmp : Employee
    {
        ...
        {
            base.Accept();
            Console.WriteLine("Enter total hours of work");
        ...
        {
            base.Print();
            Console.WriteLine("your wage is "+(_hours*_rate));

        }

        public override string ToString()
        {
            return $"{{{nameof(rate)}={rate.ToString()}, {nameof(hours)}={hours.ToString()}, {nameof(Id)}={Id.ToString()}, {nameof(Salary)}={Salary.ToString()}, {nameof(Designation)}={Designation}, {nameof(Department)}={Department.ToString()}, {nameof(Name)}={Name}, {nameof(Gender)}={Gender.ToString()}, {nameof(Birth)}={Birth}, {nameof(Address)}={Address}}}";
        }
    }
